...
app.get("/authentication/:instanceId", (req, res) => {
  ...
  const redirectUri = authenticationService.buildRedirectUri(
...
app.get("/authentication/:instanceId/confirm", (req, res) => {
  ...
  console.log("redirecting to: " + redirectUri);
  const requestBody = authenticationService.buildRequestBody(
    req.query.code,
  ...
  authenticationService.getAccessToken(requestBody).then((result) => {
    console.log("Authentication successfull");
    res.render(`index.html`, {
      baseHref: `/authentication/${serviceInstanceId}`,
...
server.listen(environment.webserver.port, () =>
  console.log(`Dashboard Webserver is running...`)
);
